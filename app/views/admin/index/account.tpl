...
{block title} SCOA | ACCOUNT {/block}
...
{capture body}
    ...
    <div class="wrapper wrapper-content">
        ...
        {if $numStaff > 4}
            ...
            <div class="alert alert-info" style="background-color: #fdfdfde0">
                You cannot add new staff at this moment, the maximum number of Administrator is 5 only.
            </div>

        {/if}


        <div class="row p-sm" id="populate_accounts"></div>
