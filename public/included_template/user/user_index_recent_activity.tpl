        ...
        {capture body}
            ...
            {if $post.files|count === 1}
                ...
                {if $type === "video" }
                    ...
                    <p><small class="text-muted">{post_detail param= $post.PDT}</small></p>
            ...
            <div class="media-body ">
                ...
                <div class="well">
                    ...
                    <h5>
                        ...
                        {position param=$post.position_target_user|default:'Any position'}
        ...
        <div class="feed-element" id="{$post.feedsId}">
            ...
            <div class="media-body ">
                ...
                {if not ($post.user_url eq $post.post_details.user_url)}
                    ...
                    <a href="javascript:void 0">{user_fullname param=$post.post_details|default:'User'}</a>
                ...
                <div class="well">
                    <h5>
                        ...
                        <a href="#">{user_fullname param=$post.post_details|default:'User'}</a>
...
<!--<div class="feed-element">-->
    <!--<a href="#" class="pull-left">-->
        <!--<img alt="image" class="img-circle profile" src="{$public}/files/default_image/blank1profile.jpg">-->
    <!--</a>-->
    <!--<div class="media-body ">-->

        <!--<strong><a> Mark Anthony Libres</a> </strong> upload a files on <a href="#">Programming of Information Technology Students</a>.-->
        ...
        <!--<div class="well">-->
            ...
            <!--<p><a href="#"><i class="fa fa-download"></i> &nbsp;-->
                <!--Download attachments</a> | <a href="#">View all</a></p>-->
