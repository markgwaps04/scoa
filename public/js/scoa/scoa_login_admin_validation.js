        ...
        var e = function() {
            ...
            jQuery(".sign-up-form").validate({
                ...
                highlight: function(e) {
                    ...
                    jQuery(e).closest(".form-group,.controls").removeClass("is-invalid").addClass("is-invalid")
                ...
                success: function(e) {
                    ...
                    jQuery(e).closest(".form-group,.controls").removeClass("is-invalid"), jQuery(e).remove()
