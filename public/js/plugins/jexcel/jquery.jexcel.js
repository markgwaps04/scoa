...
var methods = {
    ...
    init : function( options ) {
        ...
        var defaults = {
            ...
            toolbar:null,
            // About message
            about:`The Student’s Commission on Audit (SCOA) is an organization that has the power, authority and duty to examine, audit and settle all accounts and expenditures of the funds and properties of every organizations in UM Digos College.
...
Its principle is to strengthen transparency and reliability in auditing the prepared financial statement in every clubs and organizations by the end of the semester.`
        ...
        if (options.toolbar && options.toolbar.length) {
            ...
            $.each(options.toolbar, function(k, v) {
                if (v.type == 'i') {
                    ...
                    $(toolbar).prop('class', 'jexcel-toolbar-item material-icon');
                    ...
                    if ($.fn.jexcel.current == $(table).prop('id')) {
                        ...
                        if ($(e.target).parent().parent().is('tbody')) {
                            ...
                            if ($(e.target).is('.jexcel_label')) {
                                ...
                                if ($.fn.jexcel.ignoreEvents != true && id !== undefined) {
    ...
    deleteColumn : function(columnNumber, numOfColumns) {
        ...
        // Before delete
        if ($.fn.jexcel.ignoreEvents != true) {
            if (typeof(options.beforedeleteColumn) == 'function') {

               var pospone = options.beforedeleteColumn($(this), columnNumber, numOfColumns, records);
            ...
            Array.prototype.sortBy = function(p, o) {
                ...
                return this.slice(0).sort(function(a, b) {
                    ...
                    if (Number(a[p]) == a[p] && Number(b[p]) == b[p]) {
                        ...
                        //A and B is length 3 while p is just 2
    ...
    setComments : function(cell, comments) {
        ...
        if ($.fn.jexcel.ignoreEvents != true) {
            ...
            if (typeof(options.afterSetComment) == 'function') {

               options.afterSetComment($(this));
