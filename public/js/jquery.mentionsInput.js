...
(function ($, _, undefined) {
    ...
    var defaultSettings = {
        ...
        templates     : {
            ...
            autocompleteListItem       : _.template('<li class="users-list" data-ref-id="<%= id %>" data-ref-type="<%= type %>" data-display="<%= display %>"><%= content %></li>'),
            autocompleteListItemAvatar : _.template('<img class="img-circle img-sm pull-left" src="<%= avatar %>" />'),
    ...
    var MentionsInput = function (settings) {
        ...
        var domInput,
         ...
         mentionsCollection = settings.defaultCollection || [];
