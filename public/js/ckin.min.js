...
function scoa_video_init(_selector = 'video',callback = null)
{


    wrapPlayers();
    /* Get Our Elements */
    var players = document.querySelectorAll('.ckin__player:not(.scoa-video)');
    ...
    players.forEach(function (player) {
        ...
        var videos = player.querySelectorAll(_selector);
        ...
        videos.forEach(function(video)
        {
            ...
            player.classList.add("scoa-video")
